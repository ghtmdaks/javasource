         ...
         <div class="modal-content" style="text-align: center;">
            ...
            <div class="input-group"
               ...
               <button onclick="login()" class="btn btn-link"
                  style="width: 30%; background-color: #fe4c50; border: 1px solid #fe4c50; color: white; text-decoration: none;">Login</button>
               <button type="button" class="btn btn-link" data-dismiss="modal"
                  style="width: 30%; margin-left: 200px; background-color: white; border: 1px solid #fe4c50; color: #fe4c50; font: bold; text-decoration: none;">Close</button> 
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="modal-content">
         ...
         <div class="container">
            ...
            <div class="input-group">
               ...
               <button class="btn btn-link" id="emailchk" type="button"
                  style="width: 30%; margin-left: 20px; background-color: #fe4c50; border: 1px solid #fe4c50; color: white; font-weight: bold; text-decoration: none;">Check me</button>
            </div>
            ...
            <div class="input-group">
               ...
               <button class="btn btn-link" type="button"
                  style="width: 30%; margin-left: 20px; background-color: #fe4c50; border: 1px solid #fe4c50; color: white; font-weight: bold; text-decoration: none;" id="nickchk">Check me</button>
            </div>
         ...
         <div>
            <div style = "color: #fe4c50;"><input type="checkbox" name="remember" style="margin-bottom: 15px" id = "cbox"> I accept the terms and conditions <p  id = "ccbox" class = "ft" style = "border: medium; border-color: red; font-weight: bold; color: red;"></p>            
             </div> 
         </div>   
