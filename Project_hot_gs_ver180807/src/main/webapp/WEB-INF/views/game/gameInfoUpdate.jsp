	...
	<section class="container">
		...
		<div class="breadcrumbs d-flex flex-row align-items-center">
			<ul style="text-align: right;">
	            ...
	            <li><a href="./gameView?g_num=${game.g_num}"><i class="fa fa-angle-right" aria-hidden="false"></i>${game.g_name}</a></li>
	            <li class="active"><a href="./gameInfoUpdate?g_num=${game.g_num}">
	               <i class="fa fa-angle-right" aria-hidden="true"></i>Info Update</a>
	            </li>
        	</ul>
		</div>
		<form id="gameInsertFrm" action="./gameInfoUpdate" method="post" enctype="multipart/form-data">
			<input type="hidden" name="g_num" value="${game.g_num}" />
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						<label for="g_name">Name:</label>
						<input name="g_name" type="text" class="form-control" id="g_name" value="${game.g_name}" placeholder="Name" required="required">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						<label for="steamAppId">Steam App ID:</label>
						<input name="steamAppId" type="text" class="form-control" id="steamAppId" value="${game.steamAppId}" placeholder="Steam App ID" required="required">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						<label for="developer">Developer:</label>
						<input name="developer" type="text" class="form-control" id="developer" value="${game.developer}" placeholder="Developer" required="required">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						<label for="publisher">Publisher:</label>
						<input name="publisher" type="text" class="form-control" id="publisher" value="${game.publisher}" placeholder="Publisher" required="required">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input name="price" type="number" step="0.01" class="form-control" id="price" value="${game.price}" placeholder="Price" required="required">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						<label for="g_date">Release Date:</label>
						<input name="g_date" type="date" class="form-control" id="g_date" value="${game.g_date}" placeholder="Release date" required="required">
					</div>
				</div>
			</div>
			<div class="form-group">
				<label for="genre">Genre:</label>
				<input id="orgGenre" onclick="genreUpdate()" class="form-control" name="genre" value="${game.genre}" >
				<div id="genreCheckbox">
					<div class="row">
			...
			<div class="form-group">
				...
				<textarea class="form-control" id="g_info" name="g_info" placeholder="Game Infomation">${game.g_info}</textarea>
			</div>
		</form>
		<div class="gameBtnDiv form-group">
			<button class="gameBtn btn btn-link" id="gameInsertBtn">수정</button>
			<button class="gameBtn btn btn-link" onfocus="location.href='./gameList'" >취소</button>
		</div>
	</section>
